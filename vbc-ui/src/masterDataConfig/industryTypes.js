...
export const tableHeadersIndustryTypes = [
  {
    keyName: 'ID',
    keyValue: 'id',
    className: '',
...
export const IndustryTypesDataVariables = {
  translation: 'adminComponents',
  filter: false,
  pageSizeFilter: true,
  title: 'Industry Types',
  canComponent: 'industry-types-listing',
  ...
  tableComponent: 'industry-types-listing',
  isModal: true,
  modalData: {
  ...
  createTitle: 'Create Industry Type',
  updateTitle: 'Update Industry Type',
  viewTitle: 'View Industry Type',
  createButton: 'Add',
  updateButton: 'Update',
  items: [
    {
