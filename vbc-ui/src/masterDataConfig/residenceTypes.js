...
export const tableHeadersResidenceTypes = [
  {
    keyName: 'ID',
    keyValue: 'id',
    className: '',
...
export const ResidenceTypesDataVariables = {
  translation: 'adminComponents',
  filter: false,
  pageSizeFilter: true,
  title: 'Residence Types',
  canComponent: 'residence-types-listing',
  ...
  tableComponent: 'residence-types-listing',
  isModal: true,
  modalData: {
  ...
  createTitle: 'Create Residence Type',
  updateTitle: 'Update Residence Type',
  viewTitle: 'View Residence Type',
  createButton: 'Add',
  updateButton: 'Update',
  items: [
    {
