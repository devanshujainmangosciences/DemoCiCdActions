...
export const tableHeadersClinicalDropOutReasons = [
  {
    keyName: 'ID',
    keyValue: 'id',
    className: '',
  ...
  {
    keyName: 'Clinical Dropout Reason',
    keyValue: 'name',
    className: '',
    showColumn: true,
    key: 1,
...
export const ClinicalDropOutReasonsDataVariables = {
  ...
  isModal: true,
  modalData: {
    title: 'Clinical Drop Out',
    items: [
      {
        label: 'Clinical Dropout Reasons',
        placeholder: 'enterClinicalDropOutReasons',
        type: 'text',
        required: true,
        value: 'name',
        variable: 'name',
  ...
  createTitle: 'Create Clinical Dropout Reason',
  updateTitle: 'Update Clinical Dropout Reason',
  viewTitle: 'View Clinical Dropout Reason',
  createButton: 'Add',
  updateButton: 'Update',
  items: [
    {
