...
export const tableHeadersEmployers = [
  {
    keyName: 'ID',
    keyValue: 'id',
    className: '',
...
export const EmployersDataVariables = {
  translation: 'adminComponents',
  filter: false,
  pageSizeFilter: true,
  title: 'Employers',
  canComponent: 'employers-listing',
  ...
  tableComponent: 'employers-listing',
  isModal: true,
  modalData: {
  ...
  createTitle: 'Create Employer',
  updateTitle: 'Update Employer',
  viewTitle: 'View Employer',
  createButton: 'Add',
  updateButton: 'Update',
  items: [
    {
