/**
 * This Component renders the Not permitted message
 * When the user try to access the route which user does not have permission
...
export default function NotPermitted() {
  const {t} = useTranslation(['notPermitted']);
            ...
            <Col
              ...
              <div>
                ...
                <h1 className="text-primary mt-5">
                  {t('not')}{' '}
                  <span className="fw-bolder">{t('authorized')}</span>
                </h1>
