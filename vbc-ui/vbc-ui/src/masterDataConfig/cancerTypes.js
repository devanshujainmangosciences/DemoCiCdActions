...
export const tableHeadersCancerTypes = [
  {
    keyName: 'ID',
    keyValue: 'id',
    className: '',
...
export const CancerTypesDataVariables = {
  translation: 'adminComponents',
  filter: false,
  pageSizeFilter: true,
  title: 'Cancer Types',
  canComponent: 'cancer-types-listing',
  ...
  tableComponent: 'cancer-types-listing',
  isModal: true,
  modalData: {
  ...
  createTitle: 'Create Cancer Type',
  updateTitle: 'Update Cancer Type',
  viewTitle: 'View Cancer Type',
  createButton: 'Add',
  updateButton: 'Update',
  items: [
    {
